...
class Source(Base):
    ...
    organ = Column(Enum(u'liver', u'lung', u'blood', u'brain', u'kidney', u'breast', u'ovary', u'prostate', u'pancreas', u'bone marrow', u'colon', u'skin', u'stomach'), nullable=False, index=True)
    organism = Column(Enum(u'human', u'mouse', u'dog'), nullable=False)
    histology = Column(Enum(u'tumor', u'adjacent benign', u'benign', u'cell line', u'PBMC', u'PML', u'RCC', u'AML', u'HCC', u'CCC', u'CML'), nullable=False, index=True)
    dignity = Column(Enum(u'malignant', u'benign'), nullable=False, index=True)
    celltype = Column(Enum(u'PBMC', u'None', u'bulk'), index=True, server_default=text("'None'"))
    person = Column(Enum(u'Claudia Berlin', u'Juliane Stickel', u'Armin Rabsteyn', u'Daniel Kowalewski', u'Nico Trautwein', u'Marc Guender'))
    fk_hla_lookup_id = Column(ForeignKey(u'hla_lookup.hla_lookup_id'), nullable=False, index=True)
    location = Column(Enum(u'NA', u'CCC'), server_default=text("'NA'"))
