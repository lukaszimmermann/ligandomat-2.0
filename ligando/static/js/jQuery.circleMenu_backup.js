...
(function ($, window, document, undefined) {
    ...
    CircleMenu.prototype.init = function () {
        ...
        self.menu_items.each(function (index) {
            var $item = $(this),
                ...
                pos = self.element.children('li:first-child').position();
    ...
    CircleMenu.prototype.initCss = function () {
        ...
        self.element.children('li:first-child').css({
                ...
                'width': (self.options.item_diameter + 20) + 'px',
                'height': (self.options.item_diameter + 20) + 'px',
                'line-height': (self.options.item_diameter + 20) + 'px',
                'font-size': '18px'
            }
        );
        //self.menu_items.css({
